...
const TrainingEngine = (() => {
    ...
    const MODULES = {
        ...
        'project-handover-process': { name: 'Project Handover Process',     level: 'senior',    xp: 750,  order: 8,  file: 'modules/project-handover-process/index.html' },
        'grid-code-hub':      { name: 'Grid Code Knowledge Hub',            level: 'senior',    xp: 800,  order: 9,  file: 'modules/grid-code-hub/index.html' },
        'dmat-ner':           { name: 'DMAT/NER Alignment Checklist',       level: 'senior',    xp: 700,  order: 10, file: 'modules/dmat-ner/index.html' },
